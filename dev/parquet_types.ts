  ...
  public static read(input: thrift.TProtocol): ColumnMetaData {
    ...
    while (true) {
      ...
      switch (fieldId) {
        ...
        case 5:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_67: Int64 = input.readI64();
        ...
        case 6:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_68: Int64 = input.readI64();
        ...
        case 7:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_69: Int64 = input.readI64();
        ...
        case 9:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_72: Int64 = input.readI64();
        ...
        case 10:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_73: Int64 = input.readI64();
        ...
        case 11:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_74: Int64 = input.readI64();
  ...
  public static read(input: thrift.TProtocol): ColumnChunk {
    ...
    while (true) {
      ...
      switch (fieldId) {
        ...
        case 2:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_79: Int64 = input.readI64();
        ...
        case 4:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_81: Int64 = input.readI64();
        ...
        case 6:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_83: Int64 = input.readI64();
  ...
  public static read(input: thrift.TProtocol): RowGroup {
    ...
    while (true) {
      ...
      switch (fieldId) {
        ...
        case 2:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_89: Int64 = input.readI64();
        ...
        case 3:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_90: Int64 = input.readI64();
  ...
  public static read(input: thrift.TProtocol): PageLocation {
    ...
    while (true) {
      ...
      switch (fieldId) {
        case 1:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_93: Int64 = input.readI64();
        ...
        case 3:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_95: Int64 = input.readI64();
...
export class ColumnIndex {
  ...
  public write(output: thrift.TProtocol): void {
    ...
    if (this.null_counts != null) {
      ...
      this.null_counts.forEach((value_102: Int64): void => {
  ...
  public static read(input: thrift.TProtocol): ColumnIndex {
    ...
    while (true) {
      ...
      switch (fieldId) {
        ...
        case 5:
          if (fieldType === thrift.Thrift.Type.LIST) {
            const value_110: Array<Int64> = new Array<Int64>();
            ...
            for (let i_11: number = 0; i_11 < size_11; i_11++) {
              const value_111: Int64 = input.readI64();
  ...
  public static read(input: thrift.TProtocol): FileMetaData {
    ...
    while (true) {
      ...
      switch (fieldId) {
        ...
        case 3:
          if (fieldType === thrift.Thrift.Type.I64) {
            const value_119: Int64 = input.readI64();
